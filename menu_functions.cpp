...
void edit_item(food*vector, int number_of_lines)
{
	...
	string edit_barcode;
	int found = 0;
	cout << "Which item do you want to edit?(Enter barcode):\n";
	cin >> edit_barcode;
	...
	for (counter = 0; counter < number_of_lines; counter++)
	{
		if (vector[counter].barcode == edit_barcode)
		{
			found = 1;
			system("cls");
			cout << "Food to be edited: \n\n";
			cout << "                   Name: " << vector[counter].food_name << endl;
			cout << "                   Quantity: " << vector[counter].quantity << endl;
			cout << "                   Cost: \x9c " << vector[counter].cost << endl;
			cout << "                   Expiry Date: " << vector[counter].expiry_date << endl;
			cout << "                   Barcode: " << vector[counter].barcode << endl;
			string edit_option;
			cout << "\n\nFor the following food item enter new details:\n\n";
			cout << "\nEnter new quantity: \n"; cin >> vector[counter].quantity;

			cout << "\nEnter new cost: \n"; cin >> vector[counter].cost;


			cout << "\nEnter new expiry date (in format:date/month/year) : \n"; cin >> vector[counter].expiry_date;
